...
import { heroAcademicCap, heroArrowPath, heroCurrencyDollar, heroExclamationTriangle, heroHomeModern, heroMagnifyingGlass, heroPencil, heroPlus, heroTrash, heroXCircle } from '@ng-icons/heroicons/outline';
